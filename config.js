...
const CONFIG = {
    API_URL: "https://webapi69729b4505d2f76d64186a5d-production.up.railway.app"
};
...
(function() {
    ...
    function getBoardId() {
        ...
        console.warn('Mentor tracking OMG: CONFIG.API_URL not available or does not contain valid boardId pattern');
        return null;
    }
